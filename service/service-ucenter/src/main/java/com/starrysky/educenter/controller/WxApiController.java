...
import com.starrysky.educenter.utils.ConstantPropertiesUtil;
import com.starrysky.educenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String callback(String code, String state){
        ...
        try {
            ...
            throw new StarrySkyException(20001, "获取access_token失败");
        }
        ...
        if(member == null){
            ...
            try {
                ...
                throw new StarrySkyException(20001, "获取用户信息失败");
            }
    ...
    public String genQrConnect(HttpSession session) {
        ...
        try {
            ...
            throw new StarrySkyException(20001, e.getMessage());
        }
